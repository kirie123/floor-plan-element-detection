...
def test_single_image():
    """测试单张图像"""
    stride = 16
    detector = IntegratedDetector(stride = stride, detection_model_path = "weights/best_detect_model_old.pth")
    ...
    image_path = "F:\\项目数据\\中石化比赛\\以图找图工程图纸智能识别\\初赛发布\\企业微信截图_1761544491195.png"
